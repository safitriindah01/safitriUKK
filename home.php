...
<div class="row">
    <div class="col-xl-3 col-md-6">
        <div class="card text-white mb-4" style="background-color: rgb(135, 206, 250) ;">
            <div class="card-body">

                <body class="img js-fullheight" style="background-image: url(assets/img/lll.jpg);background-size: 1920px 960px;">
                    <?php
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card text-white mb-4" style="background-color: rgb(186, 85, 211) ;">
            <div class="card-body">
                <?php
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card text-white mb-4" style="background-color: rgb(186, 85, 211) ;">
            ...
            <div class="card-footer d-flex align-items-center justify-content-between">
                ...
                <div class="small tex\t-white"><i class="fas fa-angle-right"></i></div>
            </div>
        </div>
    </div>
</div>
